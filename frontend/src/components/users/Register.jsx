...
const Register = () => {
  ...
  const { loading, error, isAthenticated } = useSelector((state) => state.auth);
  ...
  }, [dispatch, alert, isAthenticated, error, navigate]);
  ...
  const submitHandler = (e) => {
    ...
    formData.set("passwordConfoirm", passwordConfirm);
